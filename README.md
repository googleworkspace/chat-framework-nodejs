...
[`Transport`[docs/reference/interfaces/_google_chat_sdk.Transport.html] interface and
...
Handlers are called with a [context](docs/reference/classes/_google_chat_sdk.eventContext.html) object
