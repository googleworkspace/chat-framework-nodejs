[Google Chat SDK](../README.md) / [chat\_v1](../modules/chat_v1.md) / Params$Resource$Spaces$Get

# Interface: Params$Resource$Spaces$Get

[chat_v1](../modules/chat_v1.md).Params$Resource$Spaces$Get
...
- [$.xgafv](chat_v1.Params_Resource_Spaces_Get.md#$.xgafv)
- [access\_token](chat_v1.Params_Resource_Spaces_Get.md#access_token)
- [alt](chat_v1.Params_Resource_Spaces_Get.md#alt)
- [auth](chat_v1.Params_Resource_Spaces_Get.md#auth)
- [callback](chat_v1.Params_Resource_Spaces_Get.md#callback)
- [fields](chat_v1.Params_Resource_Spaces_Get.md#fields)
- [key](chat_v1.Params_Resource_Spaces_Get.md#key)
- [name](chat_v1.Params_Resource_Spaces_Get.md#name)
- [oauth\_token](chat_v1.Params_Resource_Spaces_Get.md#oauth_token)
- [prettyPrint](chat_v1.Params_Resource_Spaces_Get.md#prettyprint)
- [quotaUser](chat_v1.Params_Resource_Spaces_Get.md#quotauser)
- [uploadType](chat_v1.Params_Resource_Spaces_Get.md#uploadtype)
- [upload\_protocol](chat_v1.Params_Resource_Spaces_Get.md#upload_protocol)
